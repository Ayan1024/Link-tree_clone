      ...
      <main>
        <section className="bg-[#254F1A] min-h-[130vh] grid grid-cols-2">
          <div className="flex justify-center flex-col ml-[5vw]">
            ...
            <p className="text-[#D2E823] font-bold text-7xl mb-5">simple link in bio.</p>
            ...
            <div className="form mt-16">
              ...
              />
              <button className="rounded-full bg-[#E9C0E9] px-7 py-5 text-lg font-semibold">
                Claim your Linktree
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center flex-col mr-[5vw]">
            <Image src="/rotate1.png" alt="rotate images" width={400} height={400} />
          </div>
        </section>
